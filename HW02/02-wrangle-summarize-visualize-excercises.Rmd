...
There appears to be a negative correlation between FertilityRate and LifeExpectancy. 
...
correlation_WHO <- data_WHO %>% 
  ...
  filter(!(is.na(FertilityRate) | is.na(LifeExpectancy))) %>%
  group_by(Region) %>%
  # TODO: correlation scores appear double - make sure that doesn't happen
