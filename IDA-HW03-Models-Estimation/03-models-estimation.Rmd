...
Z will become wider, that is, its standard deviation will be 2, instead of 0,001. 
...
tibble(
  uni = rdunif(n_samples, 0, 1),
  irvin_hall = rdunif(n_samples, sum(uni))
  ) %>% 
