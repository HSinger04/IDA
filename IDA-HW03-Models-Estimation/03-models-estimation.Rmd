...
# alternative: composit of beta and binomial (but something is off)
n_samples <- 1000000
tibble(
  prior_c = rbeta(n_samples, 163, 21839),
  k_c = rbinom(n_samples, 22000, prior_c)
  ) %>% 
  ggplot(aes(x =k_c)) +
  geom_density()
...
With a certainty of 95%, we can assume that the probability to be infection by Covid19 without the vaccine was between 
