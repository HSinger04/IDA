...
Solution: 
Easily verbalized items will be learned faster and retained better in memory.
> "Learning Speed": The learning speed for easily verbalized is higher than for not-easily verbalized.
...
> "Accuracy": accuracy is higher for easily verbalized than for not-easily verbalized.
...
Learning speed is a metric factor (at least 60)
