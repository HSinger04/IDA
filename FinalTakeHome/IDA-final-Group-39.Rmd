...
**Solution:**
The additional hypothesis tested for in the analysis of strategy model fit is whether model type (CA vs FR) has an influence on the model fit (scores), so whether there is a general preference for one strategy (in this case CA), without taking into account the influence of condition.
